...
export type Service = {
  ...
  features: string[];
  image: string;
  icon: 'home' | 'kitchen' | 'living' | 'bed' | 'office' | 'commercial' | 'sofa';
};
...
export type PortfolioItem = {
  id: number;
  title: string;
  category: 'Residential' | 'Kitchen' | 'Living' | 'Bedroom' | 'Office' | 'Commercial';
  location: string;
  image: string;
  span?: boolean;
};
...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    image:
      'https://images.pexels.com/photos/10417388/pexels-photo-10417388.jpeg?auto=compress&cs=tinysrgb&w=800',
    social: { linkedin: '#', instagram: '#' },
  },
  {
    name: 'Ishita Rao',
    ...
    image:
      'https://images.pexels.com/photos/7316732/pexels-photo-7316732.jpeg?auto=compress&cs=tinysrgb&w=800',
    social: { linkedin: '#', instagram: '#' },
  },
];
